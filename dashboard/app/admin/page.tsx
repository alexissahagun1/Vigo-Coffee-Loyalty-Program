        ...
        <Tabs defaultValue="overview" className="space-y-8">
          ...
          <TabsContent value="overview" className="space-y-8">
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
              ...
              <div className="rounded-xl border border-border bg-card p-6 opacity-0 animate-slide-up" style={{ animationDelay: '0.4s' }}>
                <div className="flex items-center gap-2 mb-6">
                  <Coffee className="w-5 h-5 text-primary" />
                  <h3 className="font-display text-xl font-semibold">Reward Progress</h3>
                </div>
                <div className="space-y-6">
                  <div>
                    <div className="flex items-center justify-between mb-2">
                      <span className="text-sm text-muted-foreground">Coffee Rewards (every 10 pts)</span>
                      <span className="text-sm font-medium">842 claimed</span>
                    </div>
                    <div className="h-3 bg-secondary rounded-full overflow-hidden">
                      <div className="h-full bg-gradient-to-r from-primary to-primary/70 rounded-full w-[75%]" />
                    </div>
                  </div>
                  <div>
                    <div className="flex items-center justify-between mb-2">
                      <span className="text-sm text-muted-foreground">Meal Rewards (every 25 pts)</span>
                      <span className="text-sm font-medium">356 claimed</span>
                    </div>
                    <div className="h-3 bg-secondary rounded-full overflow-hidden">
                      <div className="h-full bg-gradient-to-r from-warning to-warning/70 rounded-full w-[45%]" />
                    </div>
                  </div>
                  <div className="pt-4 border-t border-border">
                    <div className="flex items-center justify-between">
                      <span className="text-sm font-medium">Average points per customer</span>
